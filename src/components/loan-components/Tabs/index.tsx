    ...
    return (
        <section className='about-info about-info_spacing'>
            <div className='about-info__tabs'>
                <ul className='about-info__items'>
                    <li className='about-info__item'>
                        <button
                            data-testid='tab-btn'
                            className={selectedTab === 1 ? 'tabs active-tabs about-info__link' : 'tabs about-info__link'}
                            onClick={() => handleClick(tabsIds.firstTab as number)}
                        >
                            About card
                        </button>
                    </li>
                    <li className='about-info__item'>
                        <button
                            className={selectedTab === 2 ? 'tabs active-tabs about-info__link' : 'tabs about-info__link'}
                            onClick={() => handleClick(tabsIds.secondTab as number)}
                        >
                    ...
                    <li className='about-info__item'>
                        <button
                            className={selectedTab === 3 ? 'tabs active-tabs about-info__link' : 'tabs about-info__link'}
                            onClick={() => handleClick(tabsIds.thirdTab as number)}
                        >
                            Cashback
                        </button>
                    </li>
                    <li className='about-info__item'>
                        <button
                            className={selectedTab === 4 ? 'tabs active-tabs about-info__link' : 'tabs about-info__link'}
                            onClick={() => handleClick(tabsIds.fourthTab as number)}
                        >
                            FAQ
                        </button>
                    </li>
            ...
            <div className='about-info__cards'>
                <div
                    className={`about-info__tab about-info__tab-01 ${tabsIds.firstTab === selectedTab ? 'active' : ''}`}
                    id='tab_01'
                >
                    <div className='about-info__cards-items'>
                        <div className='about-info__cards-item'>
                            ...
                            <h2 className='about-info__cards-title'>Up to 50 000 ₽</h2>
                            <p className='about-info__cards-desc'>Cash and transfers without commission and percent</p>
                        </div>
                        <div className='about-info__cards-item'>
                            <svg width='40' height='40' viewBox='0 0 40 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                <path
                            ...
                            <h2 className='about-info__cards-title'>Up to 160 days</h2>
                            <p className='about-info__cards-desc'>Without percent on the loan</p>
                        </div>
                        <div className='about-info__cards-item about-info__cards-item'>
                            ...
                            <h2 className='about-info__cards-title'>Free delivery</h2>
                        ...
                        <div className='about-info__cards-item about-info__cards-item--long'>
                            ...
                            <h2 className='about-info__cards-title'>Up to 12 months</h2>
                            <p className='about-info__cards-desc'>
                        ...
                        <div className='about-info__cards-item about-info__cards-item--long'>
                            ...
                            <h2 className='about-info__cards-title'>Convenient deposit and withdrawal</h2>
                            <p className='about-info__cards-desc'>
                ...
                <div className={`about-info__tab ${tabsIds.secondTab === selectedTab ? 'active' : ''}`} id='tab_02'>
                    <div className='about-info__rates'>
                        <div className='about-info__rates-texts'>
                            <p className='about-info__rates-left'>Card currency</p>
                            <p className='about-info__rates-right'>Rubles, dollars, euro</p>
                        </div>
                        <div className='about-info__rates-texts'>
                            <p className='about-info__rates-left'>Interest free period</p>
                            <p className='about-info__rates-right'>0% up to 160 days</p>
                        </div>
                        <div className='about-info__rates-texts'>
                            <p className='about-info__rates-left'>Payment system</p>
                            <p className='about-info__rates-right'>Mastercard, Visa</p>
                        </div>
                        <div className='about-info__rates-texts'>
                            <p className='about-info__rates-left'>Maximum credit limit on the card</p>
                            <p className='about-info__rates-right'>600 000 ₽</p>
                        </div>
                        <div className='about-info__rates-texts'>
                            <p className='about-info__rates-left'>Replenishment and withdrawal</p>
                            <p className='about-info__rates-right'>
                                At any ATM. Top up your credit card for free with cash or transfer from other cards
                            </p>
                        </div>
                        <div className='about-info__rates-texts'>
                            <p className='about-info__rates-left'>Max cashback per month</p>
                            <p className='about-info__rates-right'>15 000 ₽</p>
                        </div>
                        <div className='about-info__rates-texts'>
                            <p className='about-info__rates-left'>Transaction Alert</p>
                            <p className='about-info__rates-right'>
                ...
                <div className={`about-info__tab ${tabsIds.thirdTab === selectedTab ? 'active' : ''}`} id='tab_03'>
                    <div className='about-info__cards-items'>
                        <div className='about-info__cards-item'>
                            <p className='about-info__cards-desc'>For food delivery, cafes and restaurants</p>
                            <h2 className='about-info__cards-title about-info__cards-title-lg--size'>5%</h2>
                        </div>
                        <div className='about-info__cards-item'>
                            <p className='about-info__cards-desc'>In supermarkets with our subscription</p>
                            <h2 className='about-info__cards-title about-info__cards-title-lg--size'>5%</h2>
                        </div>
                        <div className='about-info__cards-item'>
                            <p className='about-info__cards-desc'>In clothing stores and children&apos;s goods </p>
                            <h2 className='about-info__cards-title about-info__cards-title-lg--size'>2%</h2>
                        </div>
                        <div className='about-info__cards-item'>
                            <p className='about-info__cards-desc'>Other purchases and payment of services and fines</p>
                            <h2 className='about-info__cards-title about-info__cards-title-lg--size'>1%</h2>
                        </div>
                        <div className='about-info__cards-item'>
                            <p className='about-info__cards-desc'>Shopping in online stores</p>
                            <h2 className='about-info__cards-title about-info__cards-title-lg--size'>up to 3%</h2>
                        </div>
                        <div className='about-info__cards-item'>
                            <p className='about-info__cards-desc'>Purchases from our partners</p>
                            <h2 className='about-info__cards-title about-info__cards-title-lg--size'>30%</h2>
                        </div>
                    </div>
                </div>
                <div className={`about-info__tab ${tabsIds.fourthTab === selectedTab ? 'active' : ''}`} id='tab_04'>
                    <div className='about-info__faq-li'>
                        <div className='accordion-box'>
                            <h2 className='accordion-header'>Issuing and receiving a card</h2>
                            <div className='accordion'>
                                {accordionData.map(({ title, content }) => (
                                    <Accordion key={title} title={title} content={content} />
                                ))}
                            </div>
                            <h2 className='accordion-header'>Using a credit card</h2>
                            <div className='accordion'>
