...
const Footer = () => {
    return (
        <footer data-testid='footer' className='footer footer__spacer d-flex flex-column'>
            <div className='container'>
                ...
                <div className='footer__bottom d-flex flex-column justify-content-between'>
                    ...
                    <div className='cookies-info cookies-info__spacing'>
                        ...
                        small files containing information about previous visits to a website. If you do not want to use cookies,
