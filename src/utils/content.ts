...
export const accordionData = [
    {
        ...
        content: `We will deliver your card by courier free of charge.
Delivery in Moscow and St.
Petersburg - 1-2 working days. For other
regions of the Russian Federation - 2-5 working
days.`,
    },
    {
    ...
    },
    {
        ...
        content: `To obtain a credit card, you will need an income of at
                                least 25,000 rubles per month after taxes.`,
    },
    {
...
export const accordionData2 = [
    ...
    },
    {
        ...
        content:
            'ou can activate your credit card and generate a PIN code immediately after receiving the card at a bank branch using a PIN pad.',
    },
    {
...
export const genderSelect = ['MALE', 'FEMALE'];
export const maritalStatusSelect = ['MARRIED', 'DIVORCED', 'SINGLE', 'WIDOW_WIDOWER'];
export const dependentAmountSelect = [1, 2, 3, 4, 5];
export const employmentStatusSelect = ['UNEMPLOYED', 'SELF_EMPLOYED', 'EMPLOYED', 'BUSINESS_OWNER'];
